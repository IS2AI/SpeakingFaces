...
def trim_audio_by_set(dataset_path, set_name):
    print('[INFO] trim all audio files for {} set'.format(set_name))
...
def trim_audio_by_range(dataset_path, set_name, sub_id_str, sub_id_end):
...
if (sub_id_str!=0 and sub_id_end!=0):
    trim_audio_by_range(dataset_path, set_name, sub_id_str, sub_id_end):
